        ...
        for(DetailFacture detailFacture :f.getDetailFactures()){
           ...
           detailFacture.setProduit(p);
            ...
            int qte = detailFacture.getQte();
             prixTotal+=detailFacture.getProduit().getPrixUnitaire() * qte ;
             pourcentageRemise += detailFacture.getPourcentageRemise();
             montantRemise += (int)prixTotal*pourcentageRemise/100;

            detailFacture.setPrixTotal(prixTotal);
            detailFacture.setPourcentageRemise(pourcentageRemise);
